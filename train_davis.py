...
if __name__ == "__main__":
	def get_arguments():
		...
		parser.add_argument("-resume_path",type=str,default='results/checkpoints/trained/pretrained/coco_pretrained_resnet50_noIterations.pth')
		parser.add_argument("-save",type=str,default='results/checkpoints/trained/final/')
	...
	for module in model.modules():
		if isinstance(module, torch.nn.modules.BatchNorm1d): module.eval()
		if isinstance(module, torch.nn.modules.BatchNorm2d): module.eval()
		if isinstance(module, torch.nn.modules.BatchNorm3d): module.eval()
